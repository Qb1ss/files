...
# https://t.me/nikitaefremovfam/6087
...
name_project = 'Roscongress'
api_id = 28410150 #25685716
api_hash = 'ee1a49641055557a1b6dd210849ade6d' #'4d41cb933dcb53557601065985e373a3'
...
def save_to_file(user_ids: set):
    with open(f'user_parsered_{name_project}.txt', 'w') as file:
        file.write('\n'.join(user_ids))
        gd_print(f"Список юзеров успешно записан в файл 'user_parsered_{name_project}.txt'. Всего уникальных юзеров: {len(user_ids)}")
